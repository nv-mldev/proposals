...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{infra/layout.pdf} % Adjusted the scale of the image to 0.5
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{infra/sequence.pdf} % Adjusted the scale of the image to 0.5
