...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{etl/data_source.png} % Adjusted the scale of the image to 0.5
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{etl/layout.png} % Adjusted the scale of the image to 0.5
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\textwidth]{etl/flow.png} % Adjusted the scale of the image to 0.5
