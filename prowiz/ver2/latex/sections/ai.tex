...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{ai/layout.png} % Adjusted the scale of the image to 0.5
        \caption{}
    \end{figure}
\end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\textwidth]{ai/flow.png} % Adjusted the scale of the image to 0.5
%         \caption{}
%     \end{figure}
% \end{frame}
