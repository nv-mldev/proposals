...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\textwidth]{api/layout.png} % Adjusted the scale of the image to 0.5
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\textwidth]{api/flow.png} % Adjusted the scale of the image to 0.5
%     \end{figure}
% \end{frame}
